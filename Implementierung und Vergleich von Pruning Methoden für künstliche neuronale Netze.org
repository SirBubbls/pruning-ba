...
Einige der häufig eingestzten Aktivierungsfunktionen können in Tabelle ref:tab:aktivierungsfunktion gefunden werden.
...
Da bereits in Kapitel ref:perceptron auf die Beschaffenheit eines Layers einegegangen wurde, können wir einen Layer $L$ als eine Funktion $f(x)$ betrachten.
